...
document.body.addEventListener("click", function () {
      ...
      music.play().then(() => {
        ...
        document.querySelector(".tap-to-start").style.display = "none";
      }).catch((error) => {
...
function showStep(step) {
    ...
    switch(step) {
        case 1:
            // Animate envelope (if you have an envelope element, otherwise skip)
            break;
        case 2:
            // Animate heart
        ...
        case 3:
            ...
            break;
        case 4:
            // Animate polaroids or carousel
            if (document.getElementById('carouselWrapper')) {
                startRotatingCarousel();
            } else {
                gsap.from(".polaroid", {
                    y: 100,
                    opacity: 0,
...
function typeMessage() {
    const messages = [
        `Dear ${userName},`,
        "On your special day, I want you to say...",
        "Happy Birthday to my dearest Friend...❤",
        "Who's always there to lend a helping hand and listening ear.",
        ...
        "Who deserve the world and more.",
